                ...
                <div className="page">
                    <div className="body absolute text-2xl ">
                        ...
                        <div className="flex justify-center item-center lg:hidden md:hidden ">
                            <img className=" size-24  absolute mt-32 " src="https://www.hackodisha.tech/Images/HO3.svg" />
                        </div>
                        <div className="flex justify-center item-center lg:hidden md:hidden " >
                            <img className="absolute w-[230px] opacity-40 mt-16 " src=" https://www.hackodisha.tech/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcircle-anim.fbd86c5f.gif&w=3840&q=75" />
                        </div>

                        <div className="building  ">
                            <div className=" para relative text-xl text-white text-justify text-balance lg:mx-24 lg:pl-72 md:mx-16 md:pl-28 lg:pt-28 md:pt-28 pt-80 mx-10">
